...
Build when you need.`,
  ...
  skillHub: {
    ...
    newSkill: {
      ...
      importHint: "Drop a .zip skill bundle or a SKILL.md here, or click to browse. The name below is used if set; otherwise it comes from the file.",
      importing: "Uploading…",
      ...
      singleFileOnly: "Please upload one skill at a time. Nothing was imported — upload \"{name}\" on its own.",
    },
    editor: {
      skillMd: "SKILL.md",
      preview: "Preview",
